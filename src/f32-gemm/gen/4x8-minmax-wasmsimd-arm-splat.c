  ...
  do {
    ...
    if XNN_LIKELY(nc >= 8) {
      ...
      if (nc & 2) {
        ...
        *(c3 + 1) = wasm_f32x4_extract_lane(vacc3x0123, 1);
        *(c2 + 1) = wasm_f32x4_extract_lane(vacc2x0123, 1);
        *(c1 + 1) = wasm_f32x4_extract_lane(vacc1x0123, 1);
        *(c0 + 1) = wasm_f32x4_extract_lane(vacc0x0123, 1);
