  ...
  do {
    ...
    assert(w <= 4 * sizeof(float));
    {
      ...
      if XNN_LIKELY(w == 4 * sizeof(float)) {
        ...
        if (w & (2 * sizeof(float))) {
          *((double*) o5) = wasm_f32x4_extract_lane(vo5, 0); o5 += 2;
          *((double*) o4) = wasm_f32x4_extract_lane(vo4, 0); o4 += 2;
          *((double*) o3) = wasm_f32x4_extract_lane(vo3, 0); o3 += 2;
          *((double*) o2) = wasm_f32x4_extract_lane(vo2, 0); o2 += 2;
